...
export function updateTransformSession(options, pointerCurrent) {
    ...
    if (options.kind === 'resize') {
        ...
        if (options.lockAspectRatio) {
            ...
            const factorFromX = options.transformStart.scaleX === 0
                ? 1
                : clampScale(candidateScaleX) / options.transformStart.scaleX;
            const factorFromY = options.transformStart.scaleY === 0
                ? 1
